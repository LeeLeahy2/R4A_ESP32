...
void setup()
{
    ...
    // Include the r4aMalloc and new/delete routines
    r4aEsp32HeapDisplay(&Serial);
    r4aMallocMaxBytes = 0;
    r4aMallocDebug = true;
    int32_t * junk = (int32_t *)r4aMalloc(sizeof(* junk), "junk");
